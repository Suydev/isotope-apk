...
| Regression tests | PASS | 2026-06-30 | local branch | `npm test`: 10 tests passed |
...
| Android bundle/native patch application | PASS | 2026-06-30 | local branch | `npm run apply-patches`: 14 patches first pass, 0 skipped, 0 required failures |
