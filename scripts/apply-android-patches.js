...
patchFile(authBundle2, [
  ...
  // NOTE: committed www/ Auth bundle already carries __mapOAuthError on this path;
  // kept for regeneration parity but non-required to avoid build failure on drift.
  [
